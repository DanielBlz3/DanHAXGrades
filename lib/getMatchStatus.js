import formatMatchTimestamp from './timeFormatter.js';

function getMatchStatus(match) {
    const status = {}
    status.scoreStr = match.scoreline || ""
    status.aggregateScore = match.aggregateScore || null
    status.penScore = match.penScore || null
