        ...
        for (const team of participants[groupNum]) {
            class teamTable {
                constructor(team) {
                    ...
                    const maxLeagueStageMatches = leagueDetails.leagueDesc.leaguePhaseLength
                    const matchLength = teamMatches.length > maxLeagueStageMatches ? maxLeagueStageMatches : teamMatches.length
                    for (let match = 0; match < matchLength; match++) {
                    ...
                    this.matchesPlayed = matchLength
                }
            }
